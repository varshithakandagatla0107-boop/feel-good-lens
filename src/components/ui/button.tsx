...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-wellness hover:bg-primary/90",
        ...
        wellness: "gradient-wellness text-white shadow-wellness hover:shadow-glow transform hover:scale-105 transition-bounce",
        mood: "bg-muted text-muted-foreground hover:bg-accent hover:text-accent-foreground shadow-soft transition-bounce transform hover:scale-105",
      },
      size: {
